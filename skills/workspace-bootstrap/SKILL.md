...
description: 'Phase 1 workspace bootstrap for Copilot-first Java/Quarkus multi-repo workspaces. Creates or repairs the .github runtime, inventories repositories and managed targets, and audits MCP safety. Use after adding the toolkit to a workspace.'
...
- Refreshing `.ai/memory/workspace-map.json` after repositories or managed shell targets change.
...
2. Review the environment JSON, repository count, managed target count, and any removed legacy paths.
...
- [ ] `.github/bootstrap/control-plane.json` and `.github/memory/workspace-shell.md` exist
